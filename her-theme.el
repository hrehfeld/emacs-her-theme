  ...
  (apply
   ...
   `(her
    ...
    ;;; color-theme mapping
	 ...
	 (rainbow-delimiters-depth-1-face ((t (:foreground nil :weight bold :inherit her-theme-hierarchy-1-face))))
	 (rainbow-delimiters-depth-2-face ((t (:foreground nil :weight bold :inherit her-theme-hierarchy-2-face))))
	 (rainbow-delimiters-depth-3-face ((t (:foreground nil :weight bold :inherit her-theme-hierarchy-3-face))))
	 (rainbow-delimiters-depth-4-face ((t (:foreground nil :weight bold :inherit her-theme-hierarchy-4-face))))
	 (rainbow-delimiters-depth-5-face ((t (:foreground nil :weight bold :inherit her-theme-hierarchy-5-face))))
	 (rainbow-delimiters-depth-6-face ((t (:foreground nil :weight bold :inherit her-theme-hierarchy-6-face))))
	 (rainbow-delimiters-depth-7-face ((t (:foreground nil :weight bold :inherit her-theme-hierarchy-7-face))))
	 (rainbow-delimiters-depth-8-face ((t (:foreground nil :weight bold :inherit her-theme-hierarchy-8-face))))
	 (rainbow-delimiters-depth-9-face ((t (:foreground nil :weight bold :inherit her-theme-hierarchy-9-face))))
